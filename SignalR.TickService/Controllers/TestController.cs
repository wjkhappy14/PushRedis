...
namespace SignalR.Tick.Controllers
{
    public class TestController : Controller
    {
        ...
        {
            string path = Server.MapPath("/App_Data/Schroder/gateway-b-test.txt");
        ...
        {
            string path = Server.MapPath("/App_Data/YingTou/gateway-a-test.txt");
            string text = System.IO.File.ReadAllText(path);
            List<GatewayItem> items = JsonConvert.DeserializeObject<List<GatewayItem>>(text);
            string json = JsonConvert.SerializeObject(items);
        ...
        {
            string path = Server.MapPath("/App_Data/Ethereum/gateway-c-test.txt");
            string text = System.IO.File.ReadAllText(path);
            List<GatewayItem> items = JsonConvert.DeserializeObject<List<GatewayItem>>(text);
            string json = JsonConvert.SerializeObject(items);
