<%@ Page Title="ASP.NET SignalR: Message Loops Demo" Language="C#" MasterPageFile="~/SignalR.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="SignalR.Tick.Hubs.MesssagesLoops.Default" %>
