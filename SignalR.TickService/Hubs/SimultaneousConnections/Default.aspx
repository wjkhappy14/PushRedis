<%@ Page Title="ASP.NET SignalR: Simultaneous Connections Demo" Language="C#" MasterPageFile="~/SignalR.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="SignalR.Tick.Hubs.SimultaneousConnections.Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="page-header">
        ...
        <p>Demonstrates simultaneous connections. You can add new via the queryString parameters hubConnections and persistentConnections.</p>
    </div>
