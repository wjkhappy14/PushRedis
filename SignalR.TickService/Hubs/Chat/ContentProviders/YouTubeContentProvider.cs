...
namespace SignalR.Tick.Hubs.Chat.ContentProviders
{
    public class YouTubeContentProvider : EmbedContentProvider
    {
        ...
        {
           NameValueCollection queryString = HttpUtility.ParseQueryString(responseUri.Query);
