...
namespace Core
{
    public class RedisHelper
    {
        ...
        /// <returns></returns>
        public async Task<Dictionary<RedisValue, double>> SortedSetRangeByRankWithScoresAsync(string key, long start = 0,
            long stop = -1,
        ...
        public async Task<Dictionary<RedisValue, double>> SortedSetRangeByScoreWithScoresAsync(string key,
